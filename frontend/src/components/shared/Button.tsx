...
>((props, ref) => {
  const className = useMemo(() => {
    return clsx(
      "grid place-items-center font-bold rounded-xl focus-visible:ring-2 transition duration-200 ease-in-out focus:outline-none",
      {
        ...
        "dark:text-black border-double border-4 border-light-blue-500 bg-white hover:bg-gray-100 focus:bg-gray-100 dark:hover:bg-gray-200 dark:focus:bg-gray-200":
